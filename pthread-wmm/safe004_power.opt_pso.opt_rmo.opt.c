...
{
  pthread_t t1876;
  pthread_create(&t1876, NULL, P0, NULL);
  pthread_t t1877;
  pthread_create(&t1877, NULL, P1, NULL);
  pthread_t t1878;
  pthread_create(&t1878, NULL, P2, NULL);
  __VERIFIER_atomic_begin();
  ...
  main$tmp_guard1 = !(x == 2 && y == 2 && __unbuffered_p2_EAX == 1 && __unbuffered_p2_EBX == 1);

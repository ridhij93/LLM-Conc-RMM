...
define dso_local i8* @_Z7Thread0Pv(i8* %threadid) #4 personality i32 (...)* @__gxx_personality_v0 {
entry:
  %this.addr.i1 = alloca %"struct.std::__atomic_base"*, align 8
  ...
  store %"struct.std::__atomic_base"* bitcast ({ i32 }* @x to %"struct.std::__atomic_base"*), %"struct.std::__atomic_base"** %this.addr.i, align 8
...
_ZNKSt13__atomic_baseIiE4loadESt12memory_order.exit: ; preds = %monotonic.i, %acquire.i, %seqcst.i
  ...
  store i32 %7, i32* @value1, align 4
  store %"struct.std::__atomic_base"* bitcast ({ i32 }* @y to %"struct.std::__atomic_base"*), %"struct.std::__atomic_base"** %this.addr.i1, align 8
  store i32 1, i32* %__i.addr.i, align 4
  store i32 0, i32* %__m.addr.i2, align 4
  %this1.i4 = load %"struct.std::__atomic_base"*, %"struct.std::__atomic_base"** %this.addr.i1, align 8
  %8 = load i32, i32* %__m.addr.i2, align 4
  %call.i5 = invoke i32 @_ZStanSt12memory_orderSt23__memory_order_modifier(i32 %8, i32 65535)
          to label %invoke.cont.i7 unwind label %terminate.lpad.i10

invoke.cont.i7:                                   ; preds = %_ZNKSt13__atomic_baseIiE4loadESt12memory_order.exit
  store i32 %call.i5, i32* %__b.i3, align 4
  %_M_i.i6 = getelementptr inbounds %"struct.std::__atomic_base", %"struct.std::__atomic_base"* %this1.i4, i32 0, i32 0
  %9 = load i32, i32* %__m.addr.i2, align 4
  %10 = load i32, i32* %__i.addr.i, align 4
  store i32 %10, i32* %.atomictmp.i, align 4
  switch i32 %9, label %monotonic.i8 [
    i32 3, label %release.i
    i32 5, label %seqcst.i9
  ]

monotonic.i8:                                     ; preds = %invoke.cont.i7
  %11 = load i32, i32* %.atomictmp.i, align 4
  store atomic i32 %11, i32* %_M_i.i6 monotonic, align 4
  br label %_ZNSt13__atomic_baseIiE5storeEiSt12memory_order.exit

release.i:                                        ; preds = %invoke.cont.i7
  %12 = load i32, i32* %.atomictmp.i, align 4
  store atomic i32 %12, i32* %_M_i.i6 release, align 4
  br label %_ZNSt13__atomic_baseIiE5storeEiSt12memory_order.exit

seqcst.i9:                                        ; preds = %invoke.cont.i7
  %13 = load i32, i32* %.atomictmp.i, align 4
  store atomic i32 %13, i32* %_M_i.i6 seq_cst, align 4
  br label %_ZNSt13__atomic_baseIiE5storeEiSt12memory_order.exit

terminate.lpad.i10:                               ; preds = %_ZNKSt13__atomic_baseIiE4loadESt12memory_order.exit
...
_ZNSt13__atomic_baseIiE5storeEiSt12memory_order.exit: ; preds = %monotonic.i8, %release.i, %seqcst.i9
  call void @llvm.trap()
  unreachable
}
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i8* @_Z7Thread1Pv(i8* %threadid) #4 personality i32 (...)* @__gxx_personality_v0 {
entry:
  %this.addr.i1 = alloca %"struct.std::__atomic_base"*, align 8
  %__i.addr.i = alloca i32, align 4
  %__m.addr.i2 = alloca i32, align 4
  ...
  %threadid.addr = alloca i8*, align 8
  store i8* %threadid, i8** %threadid.addr, align 8
  store %"struct.std::__atomic_base"* bitcast ({ i32 }* @y to %"struct.std::__atomic_base"*), %"struct.std::__atomic_base"** %this.addr.i, align 8
  store i32 0, i32* %__m.addr.i, align 4
  %this1.i = load %"struct.std::__atomic_base"*, %"struct.std::__atomic_base"** %this.addr.i, align 8
  %0 = load i32, i32* %__m.addr.i, align 4
  %call.i = invoke i32 @_ZStanSt12memory_orderSt23__memory_order_modifier(i32 %0, i32 65535)
...
_ZNKSt13__atomic_baseIiE4loadESt12memory_order.exit: ; preds = %monotonic.i, %acquire.i, %seqcst.i
  %7 = load i32, i32* %atomic-temp.i, align 4
  store i32 %7, i32* @value2, align 4
  store %"struct.std::__atomic_base"* bitcast ({ i32 }* @x to %"struct.std::__atomic_base"*), %"struct.std::__atomic_base"** %this.addr.i1, align 8
  store i32 1, i32* %__i.addr.i, align 4
  store i32 0, i32* %__m.addr.i2, align 4
  %this1.i4 = load %"struct.std::__atomic_base"*, %"struct.std::__atomic_base"** %this.addr.i1, align 8
  %8 = load i32, i32* %__m.addr.i2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_LB.cpp() #0 section ".text.startup" {
entry:
